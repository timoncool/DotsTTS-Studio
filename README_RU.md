...
- **⚙️ Контроль** — выбор модели, тег языка (~90), `num_steps`, `guidance`, `speaker_scale`, сид; форматы **WAV / MP3 / FLAC / OGG** (48 кГц) в `output/` с таймстампами. Интерфейс **RU / EN**, тёмная тема.
